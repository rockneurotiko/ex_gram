defmodule Telex do
  ...
  method :post, "answerPreCheckoutQuery", [{pre_checkout_query_id, [:string]}, {ok, [:boolean]}, {error_message, [:string], :optional}], true
  ...
  model VideoNote, [{:file_id, :string}, {:length, :integer}, {:duration, :integer}, {:thumb, PhotoSize}, {:file_size, :integer}]
  ...
  model InlineKeyboardButton, [{:text, :string}, {:url, :string}, {:callback_data, :string}, {:switch_inline_query, :string}, {:switch_inline_query_current_chat, :string}, {:callback_game, CallbackGame}, {:pay, :boolean}]
  ...
  model InlineQueryResultGif, [{:type, :string}, {:id, :string}, {:gif_url, :string}, {:gif_width, :integer}, {:gif_height, :integer}, {:gif_duration, :integer}, {:thumb_url, :string}, {:title, :string}, {:caption, :string}, {:reply_markup, InlineKeyboardMarkup}, {:input_message_content, InputMessageContent}]

  model InlineQueryResultMpeg4Gif, [{:type, :string}, {:id, :string}, {:mpeg4_url, :string}, {:mpeg4_width, :integer}, {:mpeg4_height, :integer}, {:mpeg4_duration, :integer}, {:thumb_url, :string}, {:title, :string}, {:caption, :string}, {:reply_markup, InlineKeyboardMarkup}, {:input_message_content, InputMessageContent}]
  ...
  model Invoice, [{:title, :string}, {:description, :string}, {:start_parameter, :string}, {:currency, :string}, {:total_amount, :integer}]

  model ShippingAddress, [{:country_code, :string}, {:state, :string}, {:city, :string}, {:street_line1, :string}, {:street_line2, :string}, {:post_code, :string}]

  model OrderInfo, [{:name, :string}, {:phone_number, :string}, {:email, :string}, {:shipping_address, ShippingAddress}]

  model ShippingOption, [{:id, :string}, {:title, :string}, {:prices, {:array, LabeledPrice}}]

  model SuccessfulPayment, [{:currency, :string}, {:total_amount, :integer}, {:invoice_payload, :string}, {:shipping_option_id, :string}, {:order_info, OrderInfo}, {:telegram_payment_charge_id, :string}, {:provider_payment_charge_id, :string}]

  model ShippingQuery, [{:id, :string}, {:from, User}, {:invoice_payload, :string}, {:shipping_address, ShippingAddress}]

  model PreCheckoutQuery, [{:id, :string}, {:from, User}, {:currency, :string}, {:total_amount, :integer}, {:invoice_payload, :string}, {:shipping_option_id, :string}, {:order_info, OrderInfo}]
